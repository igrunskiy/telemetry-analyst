...
class TelemetryTrack(Base):
    ...
    __table_args__ = (
        UniqueConstraint("source", "platform_id", name="uq_telemetry_tracks_source_platform"),
        UniqueConstraint("source", "normalized_name", name="uq_telemetry_tracks_source_normalized"),
    )
